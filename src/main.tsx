...
type PlayerLocation = { lng: number; lat: number; heading: number | null };
...
function MapView({ onOpenProgress, showDiscovered, setShowDiscovered, is3D, setIs3D, showBuildings3D, setShowBuildings3D, showTerrain3D, setShowTerrain3D, showDebugMenu, playerLocation }: { onOpenProgress: (location: LocationState) => void; showDiscovered: boolean; setShowDiscovered: (value: boolean) => void; is3D: boolean; setIs3D: (value: boolean) => void; showBuildings3D: boolean; setShowBuildings3D: (value: boolean) => void; showTerrain3D: boolean; setShowTerrain3D: (value: boolean) => void; showDebugMenu: boolean; playerLocation: PlayerLocation | null }) {
  ...
  return <section className="map-view"><MapCanvas mapRef={mapRef} showDiscovered={showDiscovered} is3D={is3D} showBuildings3D={showBuildings3D} showTerrain3D={showTerrain3D} playerLocation={playerLocation} onLocationChange={handleLocationChange} onBearingChange={handleBearingChange} onZoomChange={setZoom} />
...
function App() {
  ...
  useEffect(() => {
    ...
    const handlePosition = (position: GeolocationPosition) => {
      ...
      setPlayerLocation({ lng: position.coords.longitude, lat: position.coords.latitude, heading: position.coords.heading });
    };
