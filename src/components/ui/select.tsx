...
function Select({ onChange, onValueChange, ...props }: SelectProps) {
  return (
    <SelectPrimitive.Root
      {...props}
      onValueChange={(value, eventDetails) => {
        if (typeof value === "string") onValueChange?.(value, eventDetails)
        if (typeof value === "string") onChange?.({ target: { value } })
      }}
    />
  )
}
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <CaretDown weight="regular" className="pointer-events-none size-4 text-muted-foreground" />
        }
      />
    </SelectPrimitive.Trigger>
  )
...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      >
        <Check weight="regular" className="pointer-events-none" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  )
}
