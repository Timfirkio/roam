...
const buttonVariants = cva(
  "group/button inline-flex min-w-0 shrink-0 items-center justify-center rounded-pill border bg-clip-padding font-sans font-normal whitespace-normal backdrop-blur-md transition-colors duration-150 ease-outdoor outline-none select-none focus-visible:ring-3 focus-visible:ring-focus focus-visible:ring-offset-3 focus-visible:ring-offset-ink-950 disabled:pointer-events-none disabled:border-border-muted disabled:bg-surface disabled:text-text-subtle disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        "icon-large": "size-control rounded-pill p-0",
        "icon-medium": "size-[2.375rem] rounded-pill p-0 [&_svg:not([class*='size-'])]:size-3.5",
        "icon-small": "size-8 rounded-pill p-0 [&_svg:not([class*='size-'])]:size-3",
        ...
        icon: "size-control rounded-pill p-0",
        "icon-xs": "size-8 rounded-pill p-0 [&_svg:not([class*='size-'])]:size-3",
        "icon-sm": "size-9 rounded-pill p-0 [&_svg:not([class*='size-'])]:size-3.5",
        "icon-compact": "size-8 rounded-pill p-0 [&_svg:not([class*='size-'])]:size-3",
        "icon-lg": "size-control rounded-pill p-0",
      },
    },
    defaultVariants: {
      variant: "primary",
