...
export function applyRoamBaseStyle(map: Map) {
  ...
  for (const layer of layers) {
    ...
    if (isRoad && layer.type === 'line') {
      ...
      map.setPaintProperty(layer.id, 'line-color', ['case', nonBikeableRoadFeature, '#3b1d23', isHighway, '#46504d', cyclewayFeature, ['match', ['get', 'surface'], UNPAVED_SURFACES, '#d59c67', '#2bb8b0'], surfaceColor('#55615c', '#72563d')]);
